...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Ikyy nst\n'
            + 'ORG:Creator FXC7;\n'
            + 'TEL;type=CELL;type=VOICE;waid=62881037021684:+62 881-0370-21684\n'
            + 'END:VCARD'

prefix = "#"
name = "Sadboy B O T"
rdaftar = "TERIMA KASIH SUDAH DAFTAR😁,DAN SEKARANG KAMU BISA MENGAKSES FITUR BOT DENGAN GRATIS! DAN JANGAN LUPA DONASI YA:)"
rmenu = "HAI SAHABAT DIMAS👋"
limitt = 50
ban = []
userpremium = ["6283159675585@s.whatsapp.net","62881037021684@s.whatsapp.net","6285738794583@s.whatsapp.net","6289530546833@s.whatsapp.net"] //ubah nomer kalian
